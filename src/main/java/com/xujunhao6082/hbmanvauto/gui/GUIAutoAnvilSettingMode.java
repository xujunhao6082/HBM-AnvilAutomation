...
public class GUIAutoAnvilSettingMode extends GuiContainer {
    ...
    private final List<AnvilRecipes.AnvilConstructionRecipe> recipes = new ArrayList<>();
    int index;
    int size;
    int selection;
    ...
    public void initGui() {
        ...
        this.search = new GuiTextField(this.fontRendererObj, guiLeft + 10, guiTop + 81, 84, 12);
    ...
    protected void drawGuiContainerBackgroundLayer(float inter, int mX, int mY) {
        ...
        for(int i = index * 2; i < index * 2 + 10; i++) {
            ...
            AnvilRecipes.AnvilConstructionRecipe recipe = recipes.get(i);
            ...
            itemRender.renderItemAndEffectIntoGUI(font, this.mc.getTextureManager(), recipe.getDisplay(), guiLeft + 17 + 18 * (ind / 2), guiTop + 42 + 18 * (ind % 2));
